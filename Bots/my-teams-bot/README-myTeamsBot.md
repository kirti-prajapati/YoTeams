...
3. Give the bot a handle (ex: `myTeamsBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://myteamsbot.azurewebsites.net/api/messages`
