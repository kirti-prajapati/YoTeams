...
export interface ITab2TabRemoveState extends ITeamsBaseComponentState {
    value: string;
}
export interface ITab2TabRemoveProps {

}

/**
 * Implementation of Tab_2 Tab remove page
 */
export class Tab2TabRemove  extends TeamsBaseComponent<ITab2TabRemoveProps, ITab2TabRemoveState> {
